...
public class Bonuses extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        txt_bonuses = new javax.swing.JTextField();
        ...
        jLabel10.setText("Overtime Hours");
        ...
        jLabel12.setText("Bonuses");

        txt_bonuses.setText("0.0");
        txt_bonuses.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                txt_bonusesActionPerformed(evt);
            }
        });

        txt_overtimepay.setText("0.0");
        txt_overtimepay.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                txt_overtimepayActionPerformed(evt);
            }
        });
        ...
        jPanel4Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel4Layout.createSequentialGroup()
                ...
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel4Layout.createSequentialGroup()
                        .addGap(540, 540, 540)
                        .addComponent(txt_bonuses, javax.swing.GroupLayout.PREFERRED_SIZE, 140, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(jPanel4Layout.createSequentialGroup()
                        .addGap(190, 190, 190)
                        ...
                        .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                .addGroup(javax.swing.GroupLayout.Alignment.LEADING, jPanel4Layout.createSequentialGroup()
                                    .addGap(460, 460, 460)
                                    .addComponent(txt_overtimepay, javax.swing.GroupLayout.PREFERRED_SIZE, 140, javax.swing.GroupLayout.PREFERRED_SIZE))
                                .addGroup(jPanel4Layout.createSequentialGroup()
                                    ...
                                    .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                        .addGroup(jPanel4Layout.createSequentialGroup()
                                            ...
                                            .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                            .addComponent(txt_overtime, javax.swing.GroupLayout.PREFERRED_SIZE, 140, javax.swing.GroupLayout.PREFERRED_SIZE))
                ...
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel4Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel4Layout.createSequentialGroup()
                                .addGap(118, 118, 118)
                                .addComponent(txt_bonuses, javax.swing.GroupLayout.PREFERRED_SIZE, 30, javax.swing.GroupLayout.PREFERRED_SIZE))
                            .addGroup(jPanel4Layout.createSequentialGroup()
                                .addGap(68, 68, 68)
    ...
    private void txt_bonusesActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txt_bonusesActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_txt_bonusesActionPerformed

    private void txt_overtimepayActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txt_overtimepayActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_txt_overtimepayActionPerformed
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String bn="";
        String rn="";
        if(txt_bonuses.getText().equals("0.0")==true && txt_reasons.getText().trim().isEmpty()==false)
        {
           JOptionPane.showMessageDialog(null, "Please fill the reasons for bonus");
        }
        else if(txt_bonuses.getText().equals("0.0")==false && txt_reasons.getText().trim().isEmpty()==true)
        {
           JOptionPane.showMessageDialog(null, "Please fill the reasons for bonus");
        }
        else{
            try
            {
                String sql2="select * from Bonus where EmployeeID=?";
                ...
                if(resset.next())
                {
                    bn=resset.getString("Bonuses");
                    rn=resset.getString("Reasons");
                }
            }
            catch(Exception e)
            {
        ...
        try{
            ...
            double overtimepay=overtime*Double.parseDouble(txt_wagerate.getText())*1.5;
            String otp=overtimepay+"";
            
            txt_overtimepay.setText(otp);
            
            if(txt_bonuses.getText().equals("0.0")==false){
            bn=txt_bonuses.getText()+";"+bn;
            rn=txt_reasons.getText()+";"+rn;
            }
            
            double total=0;
            StringTokenizer st=new StringTokenizer(bn,";");
            while(st.hasMoreTokens())
            {
                total=Double.parseDouble(st.nextToken())+total;
            }
            total=total+Double.parseDouble(txt_overtimepay.getText());
            
            String sql="Update Bonus set Overtime='"+txt_overtime.getText()+"',Overtimepay='"+otp+"',Bonuses='"+bn+"', "
            + " Reasons='"+rn+"' , TotalBonus='"+(total+"")+"' where EmployeeID ='"+txt_employeeID.getText()+"'" ;
           ...
           // double total=Double.parseDouble(txt_overtimepay.getText()) + Double.parseDouble(txt_bonuses.getText());
            String totalBonus=total+"";

            txt_totalBonus.setText(totalBonus);
    ...
    private void txt_searchKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txt_searchKeyReleased
        ...
        try{
            String sql1 ="select * from Bonus where EmployeeID =? ";
...
//                String housing= resset.getString("Bonuses");
//                txt_bonuses.setText(housing);
    ...
    private javax.swing.JTextField txt_bonuses;
