...
public class DeleteEmployee extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try{
            ...
            txt_gender.setSelectedItem("Male");

            String sql1="Delete from Allowance where EmployeeID=?";
            prepstate=conn.prepareStatement(sql1);
            prepstate.setString(1,txt_search.getText());
            prepstate.executeUpdate();
            //        String sql2="Delete from Bonus where EmployeeID=?";
            //        prepstate=conn.prepareStatement(sql2);
            //        prepstate.setString(1,txt_search.getText());
            //        prepstate.executeUpdate();
            //        String sql3="Delete from Deduction where EmployeeID=?";
            //        prepstate=conn.prepareStatement(sql3);
            //        prepstate.setString(1,txt_search.getText());
            //        prepstate.executeUpdate();
            //        String sql4="Delete from USERS where EmployeeID=?";
            //        prepstate=conn.prepareStatement(sql4);
            //        prepstate.setString(1,txt_search.getText());
            //        prepstate.executeUpdate();
            //        String sql5="Delete from Attendance where EmployeeID=?";
